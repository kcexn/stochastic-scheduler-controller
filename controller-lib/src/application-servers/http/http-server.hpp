...
namespace http{
    ...
    public:
        ...
        void close() override;
        HttpRequest& acquire_request() { request_mtx_.lock(); return std::get<HttpRequest>(data_); }
        void release_request() { request_mtx_.unlock(); }
        HttpResponse& acquire_response() { response_mtx_.lock(); return std::get<HttpResponse>(data_); }
        void release_response() { response_mtx_.unlock(); }
